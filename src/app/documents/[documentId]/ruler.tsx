...
export const Ruler = ()=>{
    ...
    const handleMouseMove =(e:React.MouseEvent)=>{
        ...
        if((isDraggindLeft || isDraggingRight) && rulerRef.current){
                            ...
                            >
                                {  (marker%10==0) && (
                                    <>
                                        ...
                                        <span className="absolute bottom-2 transform -translate-x-1/2 text-neutral-500 text-[10px] ">
                                            {marker/10+1}
                                        </span>
                                    </>
                                    )}
